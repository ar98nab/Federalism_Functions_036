...
export default function SubNav() {
  ...
  return (
    <Container bgImage="url('https://a5.behance.net/4488426882b47e70e924be8095a3f691ca759c7f/img/assets_discovery/category-all/assets-header.jpg')"
    bgSize="cover"
    bgPosition="center"
    ...
    >
      ...
      >
        <Box display="flex" alignItems="center" justifyContent="center">
         ...
         <p> {text3}</p>&nbsp;
          <a href="http://" style={{color:"gray"}}>Claudia silva</a>
        </Box>
      </Box>
    </Container>
  );
